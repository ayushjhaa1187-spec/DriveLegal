...
## 🗺️ Advanced Roadmap (Phase 8 → 20)

Phase 8 onward is tracked in [`ROADMAP.md`](./ROADMAP.md), with per-phase details under
[`docs/roadmap/`](./docs/roadmap/). Every sub-task is a live GitHub issue organized by
milestone (one milestone per phase).

Quick links:

- [Phase 8 — Data Excellence & Legal Auditability](./docs/roadmap/phase-08.md)
- [Phase 9 — Law Engine v2](./docs/roadmap/phase-09.md)
- [Phase 10 — UX v2](./docs/roadmap/phase-10.md)
- [Phase 11 — AI Reliability](./docs/roadmap/phase-11.md)
- [Phase 12 — Scan & Verify v2](./docs/roadmap/phase-12.md)
- [Phase 13 — Auth + Profiles](./docs/roadmap/phase-13.md)
- [Phase 14 — License Health](./docs/roadmap/phase-14.md)
- [Phase 15 — Community Hotspots](./docs/roadmap/phase-15.md)
- [Phase 16 — Global Benchmark](./docs/roadmap/phase-16.md)
- [Phase 17 — Observability](./docs/roadmap/phase-17.md)
- [Phase 18 — Security Hardening](./docs/roadmap/phase-18.md)
- [Phase 19 — Release Engineering](./docs/roadmap/phase-19.md)
- [Phase 20 — Partnerships](./docs/roadmap/phase-20.md)
